  ...
  <div class="row">
    <div class="col-md-12">
      <div class="about-template">
        <h2 class="display-4 text-center">Custumers Informations</h2>
        <div class="text-center font-weight-light">
          ...
          insitam; est usus legentis in iis qui facit eorum claritatem. Investigationes demonstraverunt lectores legere me
          lius quod ii legunt saepius. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum.
          Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis
          per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes
          in futurum.
        </div>
        <div class="about-actions">
          <a href="/home" class="btn btn-success btn-lg">
            <span class="glyphicon glyphicon-home"></span>Take Me To Home Page</a>
        </div>
      </div>
    </div>
  </div>
